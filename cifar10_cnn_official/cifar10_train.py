...
def train():
    ...
    with tf.Graph().as_default():
        ...
        # # 多次运次train()的话，cifar10.distorted_inputs()会提供随机“扭曲/剪切/...”等处理过的图像，
        # # 每次的training set都不同，相当于扩充了训练集.
        ...
        for step in range(FLAGS.max_steps):
            ...
            if step % 10 == 0:
                ...
                # # 输出实例：
                # # 2018-03-06 16:02:11.618239: step 650, loss = 3.71 (1538.1 examples/sec; 0.083 sec/batch)
